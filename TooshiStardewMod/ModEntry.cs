...
namespace Randomizer {
    ...
    public class ModEntry : Mod {
        ...
        public PossibleSwap[] PossibleSwaps = {
            ...
            new PossibleSwap("Sandy", "Maru"), new PossibleSwap("Sebastian", "Wizard"), new PossibleSwap("Jas", "Vincent"), new PossibleSwap("Krobus", "Dwarf"), new PossibleSwap("Leah", "Marnie"), new PossibleSwap("Henchman", "Bouncer"), new PossibleSwap("Jodi", "Caroline"),
        ...
        *********/
        ...
        public override void Entry(IModHelper helper) {
            ...
            //using (StreamReader reader = new StreamReader("RandomizerSettings")) { }
            ...
            //Event Raised when Player warps
        ...
        *********/
        ...
        public void playerChangedLocations()
        {
            //Showing what music is playing
            //Game1.addHUDMessage(new HUDMessage($"Song currently playing: {Game1.currentSong.Name}", 1));
        }

        //IsInitialised = true; //This is for making Portraits and Character Sprites not load loop
